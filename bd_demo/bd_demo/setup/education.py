...
from bd_demo.bd_demo.setup.setup_data import import_json
import random
...
def make_fees_structure():
	for d in frappe.db.get_list("Program"):
		...
		for academic_term in ["2017-18 (Semester 1)", "2017-18 (Semester 2)", "2017-18 (Semester 3)"]:
			...
			fee_structure.receivable_account = "Debtors - WC"
			...
			#vinh program.append("fees", {"academic_term": academic_term, "fee_structure": fee_structure.name, "amount": fee_structure.total_amount})
		program.save()
	frappe.db.commit()
