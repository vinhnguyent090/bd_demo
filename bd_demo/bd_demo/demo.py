...
import erpnext
import frappe.utils
from bd_demo.bd_demo.user import hr, sales, purchase, manufacturing, stock, accounts, projects, fixed_asset, education as user_education
from bd_demo.bd_demo.setup import education, manufacture, setup_data, healthcare
"""
Make a demo
...
bench --site demo.erpnext.dev execute bd_demo.bd_demo.demo.make

3. If Demo breaks, to continue

bench --site demo.erpnext.dev execute bd_demo.bd_demo.demo.simulate

"""
def make2(domain='Manufacturing', days=10):
...
def make(domain='Manufacturing', days=10):
